...
''')
    ...
    def create(self):
        ...
        # Create engagement
        response = Util()._request('POST', ENGAGEMENTS_URL, args['api_key'], data=request_json)
    ...
    def close(self):
        ...
        # Close engagement
        response = Util()._request('POST', ENGAGEMENTS_CLOSE_URL, args['api_key'])
    ...
    def update(self):
        ...
        # Update engagement
        response = Util()._request('PATCH', ENGAGEMENTS_ID_URL, args['api_key'], data=request_json)
